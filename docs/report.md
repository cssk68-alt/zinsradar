# Lauf-Report 2026-09-12

Erstellt: 2026-09-12T10:12:57+00:00
...
## Heute nicht gefunden - als stale behalten (20)

- **Oyak Anker Bank** (DE), stale seit 2026-09-02 (10 Tage)
- **Volkswagen Bank Sparbrief** (DE), stale seit 2026-09-08 (4 Tage)
- **JAK Medlemsbank Sparränta 1,50** (SE), stale seit 2026-09-10 (2 Tage)
- **Handelsbanken Sparränta 0,05** (SE), stale seit 2026-09-10 (2 Tage)
- **Moank Sparränta 2,40** (SE), stale seit 2026-09-10 (2 Tage)
- **LEP (Livret d’Épargne Populaire)** (FR), stale seit 2026-09-03 (9 Tage)
- **LEP (sous conditions de revenus)** (FR), stale seit 2026-09-03 (9 Tage)
- **SEB Sparränta 1,70** (SE), stale seit 2026-09-10 (2 Tage)
- **Swedbank Sparränta 1,75** (SE), stale seit 2026-09-10 (2 Tage)
- **Nordea Sparränta 1,75** (SE), stale seit 2026-09-10 (2 Tage)
- **Klarna** (SE), stale seit 2026-09-11 (1 Tage)
- **Avida Bank AB** (SE), stale seit 2026-09-09 (3 Tage)
- **0TO9** (SE), stale seit 2026-09-07 (5 Tage)
- **Lunar Sparränta** (SE), stale seit 2026-09-10 (2 Tage)
- **Lantmännen Finans Sparränta** (SE), stale seit 2026-09-10 (2 Tage)
- **Livret Jeune ≥** (FR), stale seit 2026-09-03 (9 Tage)
- **Ekobanken Sparränta 1,15** (SE), stale seit 2026-09-10 (2 Tage)
- **Nordnet Sparränta** (SE), stale seit 2026-09-10 (2 Tage)
- **Avanza Bank Sparränta** (SE), stale seit 2026-09-10 (2 Tage)
- **ICA Banken Sparränta** (SE), stale seit 2026-09-10 (2 Tage)

## Neu hinzugekommen (2)

- **Brocc Finance 0,05** (SE): 3.25 %
- **Klarna** (DE): 3.0 %
